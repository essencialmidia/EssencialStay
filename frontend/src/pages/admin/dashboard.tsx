import { AlertTriangle, Building2, DoorOpen, ExternalLink, Plus, Settings2, Sparkles, UsersRound } from "lucide-react";
...
export function AdminDashboardPage() {
  ...
  return <div className="space-y-8">
    ...
    <Card><CardHeader><CardTitle>Demonstrações</CardTitle><CardDescription>Acessos públicos para apresentações comerciais, sem depender do contexto de uma empresa cliente.</CardDescription></CardHeader><CardContent className="flex flex-col gap-3 sm:flex-row sm:flex-wrap"><a href="/demo/29-07" target="_blank" rel="noreferrer"><Button variant="outline"><ExternalLink className="size-4" />Abrir demonstração administrativa</Button></a><a href="/demo/29-07/hospedagens" target="_blank" rel="noreferrer"><Button variant="outline"><ExternalLink className="size-4" />Abrir demonstração de hospedagens</Button></a><a href="/s/hotel-monaco-demo" target="_blank" rel="noreferrer"><Button variant="outline"><ExternalLink className="size-4" />Abrir Portal do Hóspede</Button></a></CardContent></Card>
