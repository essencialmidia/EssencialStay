...
export function AutomationLabTechnicalMode({ onExitTechnicalMode }: { onExitTechnicalMode: () => void }) {
  ...
  return (
    <div className="space-y-7">
      <PageHeader
        ...
        actions={<><Button variant="outline" onClick={onExitTechnicalMode}><ArrowLeft className="size-4" />Voltar ao modo simples</Button><Button onClick={startSession} disabled={selectedScenario.status !== "active"}><Play className="size-4" />Nova Automation Session</Button></>}
      />
