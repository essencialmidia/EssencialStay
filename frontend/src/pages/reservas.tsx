...
function ManualExperienceCard({ reservation, onClose, onUpdate, onDemoCompleted, accessOpen, onAccessOpenChange }: {
    ...
    function completeFnrh() { updateManualAirbnbPreparation(reservation.id, { fnrhCompleted: true }, ["FNRH concluída"]); onUpdate(); showToast("FNRH concluída."); if (reservation.lockMode === "automatic-demo")
        void prepareAccess(); }
