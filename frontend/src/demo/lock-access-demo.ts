...
export type DemoAccessResult = { accessId: string; status: "active" | "failed"; maskedCode: string; provider: "ekaza"; demonstration: true };
...
export const DemoAutomaticAccessProvider = {
  async createTemporaryAccess(request: DemoAccessRequest): Promise<DemoAccessResult> {
    ...
    return { accessId: `demo-access-${request.reservationId}`, status: "active", maskedCode: "73••42", provider: "ekaza", demonstration: true };
  },
};
